...
module top_tb;
    ...
    initial begin
        $display(" time | reset |  coin | LoadShape | GradeIt | Start | Location | Load |  masterPattern  |      Guess      | NumGames | Round | Znarly | Zood | GameWon, RestartGame, drop");
    $display("------|-------|-------|-----------|---------|-------|----------|------|-----------------|-----------------|----------|-------|--------|------|---------");
        $monitor("  %b   |   %b   | %b, %b |     %b     |    %b    |   %b   |    %b    |  %b | %b_%b_%b_%b | %b_%b_%b_%b |   %b   |  %b |  %b  | %b |   %b ,          %b,       %b",
            CLOCK_100, reset, coinInserted, coinValue, LoadShapeNow, GradeIt, StartGame, ShapeLocation, LoadShape, dut.masterPattern[11:9], dut.masterPattern[8:6], dut.masterPattern[5:3], dut.masterPattern[2:0], Guess[11:9], Guess[8:6], Guess[5:3], Guess[2:0], NumGames, RoundNumber, Znarly,Zood, GameWon, dut.RestartGame, dut.drop);
